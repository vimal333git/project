...
//            response answer option
        ...
        $(document).on('click','.pagination_click',function () {
...
//                alert(final_answer);
                ...
                var final='<div class="form-group"><p>You have taken <b style="color: #1c7430">'+final_time+'</b> to complete the exam</p></div><div class="form-group"><p>You obtained marks is : <b style="color: #1c7430">'+final_answer+'</b> good luck ...!</p></div>';
                $('.final').html(final);
...
<div class="container start final" style="background-color: whitesmoke;height: 350px;display: none">
    ...
    <div class="row">
        <div class="col-8 question_part">cjs</div>
